...
Link to sketch
https://www.openprocessing.org/sketch/921607
My profile link 
...
function draw() {
	...
	for (let i = 0; i < 100000; i++) {
		...
		//Main point
		fill(colorAtPixel); //making sure that it's picture perfect before the change 
		rect(x, y, squareDetailSize); //random(1,10) //used to be circle, now rect
		
		//Something
		fill(r,255,255,newAlpha);
